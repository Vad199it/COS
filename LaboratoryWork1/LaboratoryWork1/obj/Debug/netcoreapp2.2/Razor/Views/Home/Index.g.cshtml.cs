#pragma checksum "F:\Универ\7 семестр\ЦОС\COS\LaboratoryWork1\LaboratoryWork1\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cb3d79aff0da2e3f34c22910de0f191926b239e2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cb3d79aff0da2e3f34c22910de0f191926b239e2", @"/Views/Home/Index.cshtml")]
...
#line hidden
            ...
            EndContext();
            BeginContext(146, 4429, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cb3d79aff0da2e3f34c22910de0f191926b239e25857", async() => {
                BeginContext(290, 4278, true);
                WriteLiteral(@"
            <div style=""display: none;"">
                ...
                <label>Частота 2<input type=""number"" step=""0.1"" name=""frequency2"" value=""1"" id=""frequency2"" onchange=""GetRequest()"" style=""width");
                ...
                WriteLiteral(@"3"" onchange=""GetRequest()"" />Квадратичный</label>
                    ...
                    <label><input type=");
                WriteLiteral(@"""radio"" name=""radio"" value=""12"" onchange=""GetRequest()"" />Все сразу</label>
                </div>
            </div>
            ...
            EndContext();
            BeginContext(4575, 89, true);
            WriteLiteral("\r\n            <div style=\"width: 700px; height: 500px;\" id=\"chart-container\"></div>\r\n    ");
            EndContext();
            BeginContext(4664, 37, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cb3d79aff0da2e3f34c22910de0f191926b239e212895", async() => {
            }
            );
        ...
        function GetRequest() {
            $.get(""/Home/AxisX?n="" + $(""#textInput"").val() + ""&m="" + $(""#textInputM"").val(),
                function (data) {                    
                    ...
                    console.log(data);
                    $.get(""/Home/AxisY?amplitude1="" + $(""#amplitude1"").val() + ""&amplitude2="" + $(""#amplitude2"").val() +");
            WriteLiteral(@" ""&amplitude3="" + $(""#amplitude3"").val() + ""&amplitude4="" + $(""#amplitude4"").val() + ""&initialPhase="" + $(""#initialphase"").val() + ""&frequency1="" + $(""#frequency1"").val()  + ""&frequency2="" + $(""#frequency2"").val() + ""&frequency3="" + $(""#frequency3"").val() + ""&frequency4="" + $(""#frequency4"").val() + ""&n="" + $(""#textInput"").val() + ""&m="" + $(""#textInputM"").val() + ""&noise="" + $('#noise').prop('checked') + ""&frequencym="" + $('#frequencym').prop('checked') + ""&amplitudem="" + $('#amplitudem').prop('checked') + ""&line="" + $('#line').prop('checked')+""&radiobutton=""+$(""#form input[type='radio']:checked"").val(),
                        function (data) {
                            console.log(data);
                            config.data.datasets = [];
                            let data1 = data.splice($(""#textInputM"").val(), data.length / 3);
                            let data2 = data.splice($(""#textInputM"").val(), data.length / 2);
                            
                            
               ");
            WriteLiteral(@"             config.data.datasets.push(Object.assign({}, dataset));
                            config.data.datasets.push(Object.assign({}, dataset));
                            config.data.datasets.push(Object.assign({}, dataset));

                            config.data.datasets[0].label = 'SKZ1';
                            config.data.datasets[0].data = data1;
                            config.data.datasets[1].data = data2;
                            config.data.datasets[2].data = data.splice($(""#textInputM"").val(), data.length);
                            
                            config.data.datasets[1].backgroundColor = ""#3383FF"";
                            config.data.datasets[1].borderColor = ""#3383FF"";
                            config.data.datasets[1].label = 'SKZ2';
                            
                            config.data.datasets[2].backgroundColor = ""#18AB35"";
                            config.data.datasets[2].borderColor = ""#18AB35"";
                       ");
            WriteLiteral("     config.data.datasets[2].label = \'Amplitude\';\r\n\r\n                        DrawChart(config);\r\n                    }\r\n                    );                    \r\n                });\r\n                        \r\n        }\r\n    </script>\r\n\r\n</div>\r\n");
            EndContext();
        }
