#pragma checksum "F:\Универ\7 семестр\ЦОС\COS\LaboratoryWork1\LaboratoryWork1\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1255228a06a44a1faaff3fab0418567db2f114e3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1255228a06a44a1faaff3fab0418567db2f114e3", @"/Views/Home/Index.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1255228a06a44a1faaff3fab0418567db2f114e35865", async() => {
        ...
        ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1255228a06a44a1faaff3fab0418567db2f114e313436", async() => {
            }
            );
        ...
        <script>
          ...
          ");
            WriteLiteral(@"          config.data.datasets[0].borderColor = ""#FFF"";
                    GetRequest();
                }
            }
            ...
            function GetRequest() {
                $.get(""/Home/AxisX?n="" + $(""#textInput"").val(),
                    function (data) {                       
                        ...
                        c");
            WriteLiteral(@"onfig3.data.labels = data;
                        ...
                        $.get(""/Home/AxisY?amplitude="" + $(""#amplitude"").val() + ""&initialPhase="" + $(""#initialphase"").val() + ""&frequency="" + $(""#frequency"").val() + ""&n="" + $(""#textInput"").val() + ""&radiobutton=""+$(""#form input[type='radio']:checked"").val() + ""&lowfrequency="" + $('#lowfrequency').prop('checked') + ""&highfrequency="" + $('#highfrequency').prop('checked') + ""&linefrequency="" + $('#linefrequency').prop('checked'),
                            function (data) {
                                ...
                                //let config3 = Object.assign({}, config);
                                //let config4 = Object.assign({}, config);

                                //config1.data.datasets = [];
                                //config1");
            WriteLiteral(@".data.datasets.push(Object.assign({}, dataset));
